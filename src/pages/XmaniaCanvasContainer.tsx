...
import CanvasComponent from "./XmaniaComponents/CanvasComponent";
import Toolbar from "./XmaniaComponents/Toolbar";
...
const exampleData = [
  ...
  },
  {
    ...
    content:
      '<p className="ql-align-center"><span style="font-size: 20px;">Table Here</span></p>',
  },
  {
    type: "TEXT",
